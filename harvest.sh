...
export COATAGLUE_HOME=/The_directory_this_file_is_in
export COATAGLUE_CODE=/The_path_containing_CoataGlue_src
export COATAGLUE_PERLLIB=$COATAGLUE_CODE/src/lib
...
$COATAGLUE_CODE/src/coataglue.pl -g
